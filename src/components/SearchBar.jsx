...
export default function SearchBar() {
  ...
  return (
    <>
      ...
      <div
        className="pr-20 max-[700px]:pr-0 p-1.5 flex items-center justify-center rounded-md text-sm cursor-pointer 
      ...
      >
        <IoIosSearch className="size-5 mr-2 text-zinc-600 dark:text-zinc-400" />
      ...
      {isActive && (
        ...
        >
          <div
            className="w-full max-w-3xl mx-auto h-[50%] min-h-[400px]
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-md py-2.5 px-2 pl-10 
            ...
            {/* Search Results */}
            <div
              className="w-full h-[90%] my-1.5 overflow-y-auto p-2 text-sm
                          ...
                          >
                            <div className="flex items-center gap-2 w-full min-w-0">
                              <div className="shrink-0">
                                <Avatar size="size-5" url={"/profile.jpg"} />
                              </div>
                            ...
                            <span
                              className="text-zinc-500 dark:text-zinc-400 
                                         max-[800px]:hidden shrink-0 ml-2
                                         text-xs font-medium
