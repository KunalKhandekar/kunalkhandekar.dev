...
export default function ProjectShowCasePage({ projectName }) {
  ...
  return (
    <div className="max-w-7xl m-auto p-6 gap-5 max-[800px]:flex-col max-[800px]:p-0 max-[800px]:bg-[#F6F8FA] max-[800px]:dark:bg-[#010409]">
      ...
      <div className="flex justify-between w-full items-center py-4 border-b border-zinc-300 dark:border-zinc-600">
      ...
      <div className="flex gap-2 py-6">
        <section className="flex-5 border border-amber-400 h-90 "></section>
        <ProjectAboutSection />
      </div>
    </div>
  );
